...
# Agent 1: Problem Analysis (HuggingFace)
        ...
        for attempt in range(max_retries):
            try:
                ...
                response = self.client.text_generation(
                    ...
                    stop_sequences=["Question:", "User:", "Human:"]
                )
                ...
                if attempt == max_retries - 1:
                    fallback = {
                        ...
                        "logic_summary": f"Failed to parse after {max_retries} attempts. Original question: {question}",
                        "dsa_topics": ["Unknown"],
...
# Agent 2: Solution Generator (OpenAI)
...
def main():
    ...
    with st.sidebar:
        ...
        st.markdown("1. **Agent 1** analyzes your problem using HuggingFace LLM")
